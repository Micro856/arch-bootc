...
RUN pacman -Syu --noconfirm gnome-shell gnome-control-center gdm nautilus sushi gnome-backgrounds gnome-desktop gnome-menus gnome-sesion gnome-color-manager gnome-keyring \
    gnome-user-share grilo-plugins gvfs gvfs-afc gvfs-dnssd gvfs-goa gvfs-google gvfs-gphoto2 gvfs-mtp gvfs-nfs gvfs-onedrive gvfs-smb gvfs-wsdd malcontent orca tecla xdg-desktop-portal-gnome xdg-user-dirs-gtk && \
  pacman -S --clean && \
  rm -rf /var/cache/pacman/pkg/* && \
